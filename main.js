...
(function () {
  ...
  var AR = {
    ...
    "footer.disclaimer": "يُذكر معهد ETH زيورخ بوصفه جهة مضيفة أو متعاونة أكاديمية مقترحة فقط. لم تُبرم أي شراكة أو تأييد أو ترتيب استضافة أو اتفاق نشر أو ترتيب لإصدار شهادات، ما لم يؤكّد معهد ETH زيورخ ذلك صراحةً.",
    ...
    /* index — UWC */
    "uwc.title": "بالتوازي مع طلب التحاق ببرنامج UWC",
    "uwc.p1": "تُطوَّر هذه المبادرة بالتوازي مع تقديم طلب التحاق ببرنامج UWC، بهدف بناء تجربة تعلّم دولية قائمة على الحوار والتنوّع والتفكير النقدي والتعاون الأكاديمي.",
    "uwc.note": "الطلب قيد النظر، ولم يصدر أي قرار قبول.",
