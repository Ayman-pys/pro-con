/* =========================================================
   Pro & Contra — 7-Day International Academic Program 2028
   Vanilla JS: navigation, reveal, form validation + submission, EN/AR
   ========================================================= */
(function () {
  "use strict";
  ...
  var AR = {
    ...
    "footer.title": "برنامج أكاديمي دولي مقترح مدّته سبعة أيام — سبتمبر ٢٠٢٨",
    ...
    /* index — meta + hero */
    "meta.title.index": "برنامج أكاديمي دولي مدّته سبعة أيام | سبتمبر ٢٠٢٨",
    "meta.desc.index": "برنامج أكاديمي دولي مقترح مدّته سبعة أيام يجمع ٢٥ طالبًا للبحث والمناظرة والكتابة والعرض من وجهتَي نظر متقابلتين حول قضية عالمية واحدة.",
    "hero.kicker": "مبادرة أكاديمية مقترحة — سبتمبر ٢٠٢٨",
    "hero.title": "منتدى دولي للتفكير النقدي",
    "hero.lead": "برنامج أكاديمي مكثّف مدّته سبعة أيام يجمع طلابًا من دول مختلفة للبحث ومناقشة وجهات النظر المتعارضة حول أسئلة عالمية معقّدة، وتحويل الأدلّة إلى كتابة أكاديمية.",
    "hero.cta1": "تعرّف على المبادرة",
    "hero.cta2": "ناقش التعاون معنا",
    "fact.0.v": "٧ أيام",
    "fact.0.l": "برنامج أكاديمي مكثّف",
    ...
    /* index — 7-day program */
    "program.title": "برنامج السبعة أيام",
    "program.lead": "تتيح الأيام السبعة للمشاركين تجاوز مناظرة واحدة واختبار عملية البحث الكاملة — من تحديد السؤال وتقييم الأدلّة إلى الكتابة الأكاديمية، والمراجعة النظيرة، والعرض النهائي.",
    "program.flow": "بحث ← مناظرة ← كتابة ← مراجعة ← عرض ← تنقيح",
    "program.day": "اليوم",
    "program.d1.t": "الموضوع وسؤال البحث",
    "program.d1.b1": "اختيار الموضوع",
    "program.d1.b2": "تحديد سؤال البحث",
    "program.d1.b3": "فهم موقفك (مع / ضدّ)",
    "program.d2.t": "البحث والمصادر",
    "program.d2.b1": "البحث عن المصادر الأكاديمية",
    "program.d2.b2": "تقييم موثوقية المصادر",
    "program.d2.b3": "جمع الأدلّة والبيانات",
    "program.d3.t": "الأدلّة وبناء الحجّة",
    "program.d3.b1": "تحليل الأدلّة",
    "program.d3.b2": "بناء الحجج",
    "program.d3.b3": "التمييز بين الدليل والرأي",
    "program.d3.b4": "اكتشاف نقاط القوة والضعف في كل موقف",
    "program.d4.t": "المناظرة والنقاش النقدي",
    "program.d4.b1": "عرض حجج الطرفين (مع وضدّ)",
    "program.d4.b2": "مناقشة الأدلّة",
    "program.d4.b3": "النقد المتبادل",
    "program.d4.b4": "تحسين الحجج بناءً على الملاحظات",
    "program.d5.t": "الكتابة الأكاديمية",
    "program.d5.b1": "بناء هيكل البحث",
    "program.d5.b2": "كتابة المقدّمة",
    "program.d5.b3": "تطوير الحجج",
    "program.d5.b4": "استخدام المصادر والاستشهادات بطريقة صحيحة",
    "program.d6.t": "المراجعة والتنقيح",
    "program.d6.b1": "مراجعة البحث",
    "program.d6.b2": "التحقّق من المصادر والاستشهادات",
    "program.d6.b3": "تحسين المنهجية والحجج",
    "program.d6.b4": "مراجعة نظيرة بين المشاركين",
    "program.d7.t": "العرض النهائي",
    "program.d7.b1": "تقديم البحث النهائي",
    "program.d7.b2": "عرض النتائج والحجج",
    "program.d7.b3": "مناقشة الأسئلة",
    "program.d7.b4": "تغذية راجعة نهائية",
    "program.d7.b5": "تجهيز مسوّدات قد تُنقَّح لاحقًا للتقديم الأكاديمي",
    "program.note": "إتمام الأيام السبعة لا يضمن نشر أي بحث. أي تنقيح أو مراجعة أو تقديم أكاديمي لاحق يتم بعد البرنامج، وليس أمرًا يمكن لهذه المبادرة أن تعِد به مسبقًا.",
    ...
    "out.lead": "صُمّم البرنامج حول أربع قدرات يتجاوز أثرها الأيام السبعة وسؤالًا واحدًا.",
    ...
    "art.p1": "يتوّج البرنامج بإنتاج مسوّدتَي بحث جماعيتين، تقدّم كل منهما وجهة نظر مدروسة ومؤسَّسة على بحث دقيق حول السؤال نفسه.",
    "art.p2": "وقراءة المسوّدتين معًا هي الحصيلة الحقيقية للبرنامج: توثيق لموضع الخلاف الفعلي، وللأدلّة التي يستند إليها كل طرف، وللأسئلة التي تبقى مفتوحة. وتُنسب كل مسوّدة إلى المجموعة التي أنتجتها كاملةً.",
    "art.note": "أي مسوّدة قد تُنقَّح لاحقًا لتقديمها أكاديميًا، لكن النشر عبر منصّة تابعة لمعهد ETH زيورخ أو أي جهة أخرى غير مضمون، وسيكون مرهونًا بالمراجعة الأكاديمية والتحريرية.",
    ...
    "eth.a2": "مكان مناسب لانعقاد البرنامج",
    ...
    /* about */
    "meta.title.about": "عن المبادرة | برنامج أكاديمي دولي مدّته سبعة أيام ٢٠٢٨",
    "meta.desc.about": "النموذج الأكاديمي وراء برنامج دولي مقترح مدّته سبعة أيام: سؤال واحد، وفريقان متقابلان، وإشراف أكاديمي، ومسوّدتان جماعيتان.",
    ...
    "why.lead": "كثيرًا ما يُطلب من الطلاب أن يتبنّوا رأيًا قبل أن يتعلّموا كيف يختبرون رأيًا. وهذه المبادرة تعكس هذا الترتيب.",
    ...
    "why.3.p": "البلاغة بلا دليل تُنتج طلابًا واثقين ونتائج هشّة. وكل ادّعاء في هذه المبادرة يجب أن يكون قابلًا للتتبّع إلى ما يمكن التحقّق منه.",
    ...
    "model.lead": "سؤال واحد يمرّ بثماني مراحل على مدى برنامج مدّته سبعة أيام، من البحث المستقل إلى مسوّدتين مكتملتين.",
    "model.1": "٢٥ طالبًا",
    ...
    "two.p": "في ختام البرنامج، ينبغي أن تكون كل مجموعة قادرة على الإجابة عن خمسة أسئلة تخصّ موقفها والموقف الذي عارضته:",
    ...
    "am.5.p": "قراءة المسوّدتين أثناء تطوّرهما والتعليق على الوضوح والمنهج والتوثيق.",
    ...
    "exp.lead": "ما ينبغي أن يصبح المشاركون أقدر عليه بعد البرنامج ممّا كانوا عليه قبله.",
    ...
    /* contact */
    "meta.title.contact": "تواصل | برنامج أكاديمي دولي مدّته سبعة أيام ٢٠٢٨",
    "meta.desc.contact": "تواصل مع منظّم برنامج أكاديمي دولي مقترح مدّته سبعة أيام لسبتمبر ٢٠٢٨. نرحّب باستفسارات الأساتذة والجامعات والمتعاونين المحتملين.",
    ...
    "ct.form.intro": "املأ النموذج أدناه وسنتواصل معك في أقرب وقت ممكن. يمكنك أيضًا مراسلتنا مباشرة عبر البريد الإلكتروني المجاور.",
    "ct.f.name": "الاسم",
    ...
    "cat.1.p": "للأساتذة والباحثين المستعدّين لتوجيه الطلاب في البحث والمناظرة والكتابة خلال البرنامج.",
    ...
    "cat.4.t": "النشر",
    "cat.4.p": "للمحرّرين والمنصّات الأكاديمية المستعدّين لتقديم المشورة بشأن مراجعة المسوّدتين النهائيتين أو نشرهما.",
    "cat.5.t": "استفسار عام",
  ...
  var STRINGS = {
    en: {
      ...
      statusSendErr: "We couldn't send your message right now. Please try again, or email us directly at dr.ayman.alkinani@gmail.com."
    },
    ar: {
      toAr: "العربية",
      toEn: "English",
      ...
      statusSending: "جارٍ إرسال رسالتك…",
      statusOk: "شكرًا لك — تم إرسال رسالتك بنجاح. سنتواصل معك قريبًا.",
      statusErr: "ما زالت بعض الحقول بحاجة إلى مراجعة. يُرجى الاطّلاع على الرسائل أعلاه.",
      statusSendErr: "تعذّر إرسال رسالتك الآن. يُرجى المحاولة مرة أخرى، أو مراسلتنا مباشرة على dr.ayman.alkinani@gmail.com."
    }
  };
  ...
  (function contactForm() {
    ...
    var fields = ["name", "email", "topic", "message"].map(function (id) {
    ...
    form.addEventListener("submit", function (event) {
      ...
      showStatus("info", s.statusSending);
      ...
      fetch(WEB3FORMS_ENDPOINT, {
        ...
        .then(function (result) {
          if (result && result.success) {
            showStatus("info", s.statusOk);
            form.reset();
          } else {
            showStatus("error", s.statusSendErr);
          }
        })
        .catch(function () {
          showStatus("error", s.statusSendErr);
